* Para instalar los módulos y las dependencias de este venv, y correrlo en otra terminal, deberás abrir la consola, ubicarte dentro de la carpeta del proyecto y ejecutar:
